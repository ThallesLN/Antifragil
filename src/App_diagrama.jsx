...
function App() {
  ...
  return (
    <div className="min-h-screen font-['DM_Sans'] transition-all duration-500 bg-gradient-to-br from-slate-900 via-gray-900 to-black text-white">
      ...
      {/* Resultados Section - Diagrama de Fluxo */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <div className="w-16 h-1 bg-gradient-to-r from-amber-500 to-orange-500 mx-auto mb-8 rounded-full"></div>
          ...
          <div className="hidden lg:block max-w-6xl mx-auto">
            <div className="relative">
                ...
                {[
                  {
                    ...
                    title: "Desenvolva uma mentalidade antifrágil",
                    step: "INÍCIO",
                    description: "Base fundamental para sua transformação"
                  },
                  {
                    icon: <TrendingUp className="w-12 h-12 text-amber-500" />,
                    title: "Desperte seu potencial máximo para uma vida próspera",
                    step: "DESPERTAR",
                    description: "Ative suas capacidades latentes"
                  }
                ].map((resultado, index) => (
                  <div key={index} className="relative">
                    <div className="p-8 rounded-2xl border bg-gradient-to-br from-slate-50 to-blue-50 border-slate-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 w-80 text-center">
                      {/* Badge do step */}
                      <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-bold rounded-full mb-4">
                        {resultado.step}
                      </div>
              ...
              <div className="flex justify-center mb-12">
                <div className="relative">
                  <div className="p-8 rounded-2xl border bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 w-80 text-center">
                    {/* Badge do step */}
                    <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-bold rounded-full mb-4">
                      TRANSFORMAÇÃO
                    </div>
                    ...
                    {/* Título */}
                    <h3 className="text-lg font-medium text-slate-800 mb-3 leading-relaxed">
                      Veja as adversidades como oportunidades de crescimento
                    </h3>
                    
                    {/* Descrição */}
                    <p className="text-sm text-slate-600 font-light">
                      Mude sua perspectiva sobre desafios
                    </p>
                  </div>
              ...
              <div className="flex justify-center space-x-16">
                {[
                  ...
                  },
                  {
                    ...
                    title: "Receba orientações para implementar o que aprendeu no Treinamento e obter Resultados duradouros",
                    step: "IMPLEMENTAÇÃO",
                    description: "Aplique e mantenha os resultados"
                  }
                ].map((resultado, index) => (
                ...
                <div key={index} className="relative">
                  <div className="p-6 rounded-2xl border bg-gradient-to-br from-slate-50 to-blue-50 border-slate-200 hover:shadow-lg transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-bold rounded-full">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="text-base font-medium text-slate-800 mb-2 leading-relaxed">
                          {resultado.title}
                        </h3>
                      </div>
                    </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-200">
              ...
              <span className="text-amber-700 font-medium">Sua jornada de transformação começa aqui</span>
